...
const char* ssid = "onymous"; //Enter your wifi network SSID
...
void gunControl() {
  ...
  //analogWrite(b1,1024);
  //analogWrite(b2,0);
  for (servo_position = 20; servo_position <=180; servo_position +=1){

    servo_1.write(servo_position);
    delay(2);
  }

  for (servo_position=180; servo_position >= 20; servo_position -=1){
